...
using ShoppingApplication.Infrastructure.Storage;
using ShoppingApplication.Types;
using ShoppingApplication.Types.Optionals;

namespace ShoppingApplication.Infrastructure.Identity;

internal sealed class IdentityManager( StorageService storage ) : AuthenticationStateProvider
{
